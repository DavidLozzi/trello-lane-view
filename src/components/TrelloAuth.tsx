...
const TRELLO_APP_KEY = '4d368ac4406e65484129bfde9916c85c'; // Public key
...
export function TrelloAuth({ onAuthenticated }: TrelloAuthProps) {
  ...
  const handleOAuthLogin = () => {
    ...
    const authUrl = `https://trello.com/1/authorize?expiration=never&scope=read&response_type=token&name=Trello%20Swimlane%20Viewer&key=${TRELLO_APP_KEY}&return_url=${encodeURIComponent(redirectUri)}`;
